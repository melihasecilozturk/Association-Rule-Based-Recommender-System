...
df_ = pd.read_csv("/Users/melihasecilozturk/Desktop/miuul/ödevler/ArmutARL-221114-234936/armut_data.csv")
df = df_.copy()
df.head()
df.describe().T
df.info()
...
#oluşturduğumuz sepetin içinde her bir hizmetten kaç tane varsa onu veriyo çıktı. eğer yoksa NAN yazıyo
...
#   fillna(0).   nan değerlere sıfır yaz
#applymap(lambda x: 1 if x > 0 else 0))      0 dan büyükse 1 yaz
...
def arl_recommender(rules_df, product_id, rec_count=1):
    ...
    recommendation_list = []  #burda alayını içine atıyo atıyor counter atarak ilk 2 değerde durdur dersen fonksiyın hızlanır
...
# (confidence a göre) sırasıyla ['15_1', '22_0', '25_0', '13_11'] bu hizmetleri de alabilirler
